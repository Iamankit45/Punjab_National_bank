...
<table border="10" width="500" height="400">
  ...
  <tr>
    ...
    <tr>
        ...
        <td>        </td>
        <td>        </td>
        <td>  <a href="http://localhost/pnb/depositor.php"target="_blank">click to view</a>      </td>
    </tr>
    <tr>
...
$fpointer = fopen("borrower.txt", "r") or exit("Unable to open read file!");
echo '<div class="tab2">';
